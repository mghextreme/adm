...
(function($) {
    ...
    var methods = {
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			var leftWidth = window.innerWidth - pos.callerleftPosition - 10;
			if (promptText == "-Selecione uma opção<br/>")
				pos.callerleftPosition += 522;
        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            return {
                "callerTopPosition": promptTopPosition,
                "callerleftPosition": promptleftPosition,
